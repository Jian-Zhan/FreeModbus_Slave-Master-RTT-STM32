        ...
        eMBParity eParity)
{
     ...
     */
    rt_pin_mode(STM32MB_SLAVE_RT_CONTROL_PIN_INDEX, PIN_MODE_OUTPUT);
...
void vMBPortSerialEnable(BOOL xRxEnable, BOOL xTxEnable)
{
    ...
    if (xRxEnable)
    {
        ...
        rt_pin_write(STM32MB_SLAVE_RT_CONTROL_PIN_INDEX, PIN_LOW);
    }
    else
    {
        /* switch 485 to transmit mode */
        rt_pin_write(STM32MB_SLAVE_RT_CONTROL_PIN_INDEX, PIN_HIGH);
